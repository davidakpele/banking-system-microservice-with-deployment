pipeline {
    agent any
     parameters {
        string(name: 'REPO_NAME', defaultValue: 'revenue-service', description: 'Name of the repository')
        string(name: 'DOCKER_IMAGE', defaultValue: 'xxxxxx/revenue-service:latest', description: 'Docker image name')
    }
    environment {
