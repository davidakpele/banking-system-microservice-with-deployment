pipeline {
    agent any
     parameters {
        string(name: 'REPO_NAME', defaultValue: 'wallet-service', description: 'Name of the repository')
        string(name: 'DOCKER_IMAGE', defaultValue: 'xxxxxx/wallet-service:latest', description: 'Docker image name')
    }
    environment {
