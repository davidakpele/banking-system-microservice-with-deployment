...
public class DepositHistoryRequest {
    ...
    public DepositHistoryRequest(BigDecimal amount, CurrencyType currencyType, String description, String ip_address,
            String message, Long userId, Long walletId, TransactionType type) {
        this.amount = amount;
