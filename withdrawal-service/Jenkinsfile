pipeline {
    agent any
     parameters {
        string(name: 'REPO_NAME', defaultValue: 'withdrawal-service', description: 'Name of the repository')
        string(name: 'DOCKER_IMAGE', defaultValue: 'xxxxxx/withdrawal-service:latest', description: 'Docker image name')
    }
    environment {
